    ...
    <>
      ...
      <Dialog open={open}>
        <DialogContent className="sm:max-w-[850px] text-black">
          <DialogHeader>
            <DialogTitle>AI 用药助手</DialogTitle>
            <DialogDescription>
              我是您的用药助手，请输入您想查询的问题
            </DialogDescription>
            <hr />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              {/* <div className="text-xs text-gray-500 mt-4 md:m-0 dark:text-gray-100">
                * 回答由 AI 检索文件后生成，不保证准确率，仅供参考学习！<a href="https://afdian.net/a/lvwzhen/plan" className='ml-1 underline decoration-wavy decoration-indigo-500 underline-offset-2 hover:text-indigo-500' target='_blank'>打赏赞助</a>
              </div> */}
